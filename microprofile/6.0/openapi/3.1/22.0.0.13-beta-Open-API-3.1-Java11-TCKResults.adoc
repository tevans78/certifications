...
+
https://download.eclipse.org/microprofile/microprofile-open-api-3.1/microprofile-open-api-spec-3.1.html[MicroProfile Open API 3.1 Specification]

* TCK Version, digital SHA-256 fingerprint and download URL:
+
https://download.eclipse.org/microprofile/microprofile-open-api-3.1/microprofile-open-api-tck-3.1.jar[MicroProfile Open API 3.1 TCK]
+
`1d04bb9f8a950a6ef1e2b53a8dc6b5d1722f1dfdf83f2d4720af281d123218bd`
