...
+
https://download.eclipse.org/microprofile/microprofile-metrics-5.0.0/microprofile-metrics-tck-5.0.0.jar[MicroProfile Metrics 5.0.0 TCK]
+
`f9f7f949cf0754b9a8ecc9b65b0c8546c479914622beeae4614c0f1bd7754f6e`
