...
== Open Liberty 23.0.0.10-beta - MicroProfile Metrics 5.1.0-RC1 Certification Summary (Java 17)
...
+
xref:23.0.0.10-beta-MicroProfile-Metrics-5.1.0-RC1-Java17-TCKResults.adoc[TCK results summary]
