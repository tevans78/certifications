...
As required by the https://www.eclipse.org/legal/tck.php[Eclipse Foundation Technology Compatibility Kit License], following is a summary of the TCK results for releases of MicroProfile Metrics 5.1.0-RC1

== Open Liberty 23.0.0.10-beta - MicroProfile Metrics 5.1.0-RC1 Certification Summary (Java 11)
...
+
https://github.com/eclipse/microprofile-metrics/tree/5.1.0-RC1[MicroProfile Metrics 5.1.0-RC1 Specification]

* (Optional) TCK Version, digital fingerprint and download URL:
+
https://repo1.maven.org/maven2/org/eclipse/microprofile/metrics/microprofile-metrics-api-tck/5.1.0-RC1/microprofile-metrics-api-tck-5.1.0-RC1.jar[MicroProfile Metrics 5.1.0-RC1 API TCK]
+
SHA-1: `b29ab221122fb30e4dc758faeae91e8d01cfdfbf`
+
https://repo1.maven.org/maven2/org/eclipse/microprofile/metrics/microprofile-metrics-optional-tck/5.1.0-RC1/microprofile-metrics-optional-tck-5.1.0-RC1.jar[MicroProfile Metrics 5.1.0-RC1 Optional TCK]
+
SHA-1: `619a066a2b1e8985d22e2268316889c258f3b5e5`
+
https://repo1.maven.org/maven2/org/eclipse/microprofile/metrics/microprofile-metrics-rest-tck/5.1.0-RC1/microprofile-metrics-rest-tck-5.1.0-RC1.jar[MicroProfile Metrics 5.0.0 Rest TCK]
+
SHA-1: `7dbaa2a3418197fd2e7a42d8f1bb5ebfbf569093`

* Public URL of TCK Results Summary:
+
xref:23.0.0.10-beta-MicroProfile-Metrics-5.1.0-RC1-Java11-TCKResults.adoc[TCK results summary]
