...
* xref:openapi/3.1/23.0.0.12-MicroProfile-Open-API-3.1.1-Java11-TCKResults.adoc[MicroProfile OpenAPI 3.1 TCK Result (Java 11)]
...
* xref:openapi/3.1/23.0.0.12-MicroProfile-Open-API-3.1.1-Java17-TCKResults.adoc[MicroProfile OpenAPI 3.1 TCK Result (Java 17)]
