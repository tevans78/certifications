...
In order to certify against MicroProfile 4.1, an implementation must pass the TCK tests for the eight included MicroProfile component specifications. Passing the five included Jakarta EE 8 specifications is optional.
